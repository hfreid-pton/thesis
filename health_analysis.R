# looking for association between fracking exposure and various health conditions
# on server filename: chisq_10_newmatch_nomove_loop.R
...
# doing 1000 iterations of nearest neighbor propensity score matching
...
# seeing dr for illness in last year
p6b23 <- c()
...
p6b30_1 <- as.integer(merged2$p6b30[1])
...
counts_k6d8_later_corrected <- chisq.test(as.table(rbind(exp_k6d8_later_10, c_k6d8_later_10)))
counts_k6d8_later_notcorrected <- chisq.test(as.table(rbind(exp_k6d8_later_10, c_k6d8_later_10)), correct=F)
...
counts_k6d8_earlier_corrected <- chisq.test(as.table(rbind(exp_k6d8_earlier_10, c_k6d8_earlier_10)))
counts_k6d8_earlier_notcorrected <- chisq.test(as.table(rbind(exp_k6d8_earlier_10, c_k6d8_earlier_10)), correct=F)


p_k6d8_earlier <- c(p_k6d8_earlier, counts_k6d8_earlier_notcorrected$p.value)
p_k6d8_later <- c(p_k6d8_later, counts_k6d8_later_notcorrected$p.value)
...
counts_p6b5_corrected <- chisq.test(as.table(rbind(exp_p6b5_10, c_p6b5_10)))
counts_p6b5_notcorrected <- chisq.test(as.table(rbind(exp_p6b5_10, c_p6b5_10)), correct=F)

# this is the same as counts_p6b5_notcorrected
p6b5_z <- prop.test(x=c(exp_p6b5_10[1], c_p6b5_10[1]), n=c(sum(exp_p6b5_10), sum(c_p6b5_10)))


p_p6b5 <- c(p_p6b5, p6b5_z$p.value)
...
counts_p6b14_corrected <- chisq.test(as.table(rbind(exp_p6b14_10, c_p6b14_10)))
counts_p6b14_notcorrected <- chisq.test(as.table(rbind(exp_p6b14_10, c_p6b14_10)), correct=F)


p6b14_z <- prop.test(x=c(exp_p6b14_10[1], c_p6b14_10[1]), n=c(sum(exp_p6b14_10), sum(c_p6b14_10)))

p_p6b14 <- c(p_p6b14, p6b14_z$p.value)
...
counts_p6b8_corrected <- chisq.test(as.table(rbind(exp_p6b8_10, c_p6b8_10)))
counts_p6b8_notcorrected <- chisq.test(as.table(rbind(exp_p6b8_10, c_p6b8_10)), correct=F)

p6b8_z <- prop.test(x=c(exp_p6b8_10[1], c_p6b8_10[1]), n=c(sum(exp_p6b8_10), sum(c_p6b8_10)))


p_p6b8 <- c(p_p6b8, p6b8_z$p.value)
...
counts_p6b19_corrected <- chisq.test(as.table(rbind(exp_p6b19_10, c_p6b19_10)))

counts_p6b19_notcorrected <- chisq.test(as.table(rbind(exp_p6b19_10, c_p6b19_10)), correct=F)


p6b19_z <- prop.test(x=c(exp_p6b19_10[1], c_p6b19_10[1]), n=c(sum(exp_p6b19_10), sum(c_p6b19_10)))

p_p6b19 <- c(p_p6b19, p6b19_z$p.value)
...
counts_p6b16_corrected <- chisq.test(as.table(rbind(exp_p6b16_10, c_p6b16_10)))
counts_p6b16_notcorrected <- chisq.test(as.table(rbind(exp_p6b16_10, c_p6b16_10)), correct=F)


p_p6b16 <- c(p_p6b16, counts_p6b16_notcorrected$p.value)
...
counts_p6b23_corrected <- chisq.test(as.table(rbind(exp_p6b23_10, c_p6b23_10)))
counts_p6b23_notcorrected <- chisq.test(as.table(rbind(exp_p6b23_10, c_p6b23_10)), correct=F)

p_p6b23 <- c(p_p6b23, counts_p6b23_notcorrected$p.value)
...
counts_p6b2_corrected <- chisq.test(as.table(rbind(exp_p6b2_10, c_p6b2_10)))
counts_p6b2_notcorrected <- chisq.test(as.table(rbind(exp_p6b2_10, c_p6b2_10)), correct=F)



p_asthma <- c(p_asthma, counts_p6b2_notcorrected$p.value)
...
write.csv(df_loop, "/home/HPA/Hannah/binary_10_loop_health_3-8.csv")
