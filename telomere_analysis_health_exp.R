...
#code name on server: /home/HPA/Hannah/telomere_analysis_health_exp_3-15.R
...
# but kept in because reusing code from my initial telomere analysis code
...
#only ran it once because just one exposed group
#but lef this in because adapted code from my original telomere analysis
#I would just stop the code once it got through the loop once
for (i in 1:1000){
print(i)
  ...
  # exposed group same
  # for comments explaining matching steps seeing matchit.R
...
#only keeping people who didn't move or who moved but didn't move schools
...
match_df <- match_df[match_df$ffFam %in% intersect_ffFam,]
match_df <- match_df %>% filter(exposure == 1)
...
#write.csv(df_loop, "/home/HPA/Hannah/telomere_analysis_loop_3-10_test.csv")
#write.csv(df_means, "/home/HPA/Hannah/telomere_analysis_loop_3-10_test_means.csv")