...
# code name on server: /home/HPA/Hannah/all_epi_clocks_EPIC_updated.R
...
# setting up vectors to hold p-values, coefficients, and means before running 1000 iterations
p_pack_15res <- c()
coef_pack_15res <- c()
...
# loop to compare exposed with 1000 iterations of matched controls
for (r in 1:1000){
print(r)
...
write.csv(df_results, "/home/HPA/Hannah/all_epi_clocks_3-8.csv")
write.csv(df_means, "/home/HPA/Hannah/all_epi_clocks_3-8_means.csv")
